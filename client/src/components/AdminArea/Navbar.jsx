    ...
    <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
      ...
      <ul className="navbar-nav ml-auto">
        ...
        <li className="nav-item dropdown no-arrow mx-1">
          <a className="nav-link dropdown-toggle" href="/admin" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
            ...
            <a className="dropdown-item d-flex align-items-center" href="/admin">
              <div className="mr-3">
        ...
        <li className="nav-item dropdown no-arrow mx-1">
          <a className="nav-link dropdown-toggle" href="/admin" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <li className="nav-item dropdown no-arrow">
          ...
          <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
            ...
            <a className="dropdown-item" href="/admin" data-toggle="modal" data-target="#logoutModal">
